...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'user@skillconnect.pk' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Muhammad' }),
    (0, class_validator_1.IsString)(),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: '42101-1234567-1', description: 'Required if role is PROVIDER' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
