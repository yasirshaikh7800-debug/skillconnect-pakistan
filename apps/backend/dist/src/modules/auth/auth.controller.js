...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Register a new Customer or Service Provider' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Login user with Email & Password (+ Optional 2FA)' }),
...
__decorate([
    ...
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Generate 2FA TOTP secret & QR Code' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)('id')),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Enable 2FA by verifying TOTP code' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
